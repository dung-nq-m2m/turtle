...
├── images/                    ← Hứng táo
├── sounds/                    ← Hứng táo
├── ne-bom/images/ + sounds/
└── ban-bong/images/ + sounds/
```
...
| Loại | File | Khi dùng |
|------|------|----------|
| Nền | `ne-bom/images/nen-dem.gif` | Bầu trời đêm |
| Bom | `ne-bom/images/bom.gif` | Quả bom rơi |
| Âm | `ne-bom/sounds/diem.wav` | Né được (+điểm) |
| Âm | `ne-bom/sounds/no.wav` | Va chạm / GAME OVER |

### Bắn bóng

| Loại | File | Khi dùng |
|------|------|----------|
| Nền | `ban-bong/images/nen-san.gif` | Sân bắn |
| Súng | `ban-bong/images/sung.gif` | Nhân vật |
| Mục tiêu | `ban-bong/images/muc-tieu.gif` | Bóng/balo trên cao |
| Âm | `ban-bong/sounds/ban.wav` | Bắn |
| Âm | `ban-bong/sounds/trung.wav` | Trúng mục tiêu |
| Âm | `ban-bong/sounds/thang.wav` | Hết mục tiêu — THẮNG |
